/*global location*/
jQuery.sap.require("com.erpis.shiperp.sls.parcelsls.common.jquery_hotkeys");
sap.ui.define([
	"com/erpis/shiperp/sls/parcelsls/controller/BaseController",
	"sap/ui/model/json/JSONModel",
	"com/erpis/shiperp/sls/parcelsls/model/formatter",
	"sap/m/Token",
	"sap/ui/model/Filter",
	"sap/m/MessageBox",
	"sap/m/MessageToast",
	"com/erpis/shiperp/sls/parcelsls/common/Utils",
	"com/erpis/shiperp/sls/parcelsls/common/hotkeyInterface",
	"com/erpis/shiperp/sls/parcelsls/common/DynamicView",
	"com/erpis/shiperp/sls/parcelsls/common/UploadUtils",
	"com/erpis/shiperp/sls/parcelsls/common/HttpHelper",
	...
	return BaseController.extend("com.erpis.shiperp.sls.parcelsls.controller.Main", {
		oLogger: jQuery.sap.log.getLogger("com.erpis.shiperp.sls.parcelsls.controller.Main"),
		formatter: formatter,
		...
		onAddDefaultHU: function () {
			if (!this.oDialogDefaultHU) {
				this.oDialogDefaultHU = sap.ui.xmlfragment("com.erpis.shiperp.sls.parcelsls.fragment.CreateDefaultHUDialog", this);
		...
		onAddNewHU: function () {
			if (!this.oDialogNewHU) {
				this.oDialogNewHU = sap.ui.xmlfragment("com.erpis.shiperp.sls.parcelsls.fragment.CreateHUDialog", this);
			...
			/*
					...
					if (oFreightUnit.isOverviewPack) {
						...
						if (!this._oHUItemsDialog) {
							this._oHUItemsDialog = sap.ui.xmlfragment("com.erpis.shiperp.sls.parcelsls.fragment.packing.HUItemsDialog", this);
		...
		onShowPricingDetail: function () {
			...
			if (!this.oRatePricingDialog) {
				this.oRatePricingDialog = sap.ui.xmlfragment("com.erpis.shiperp.sls.parcelsls.fragment.RatePricingsDialog", this);
			...
			var oRatePricingTemplate = sap.ui.xmlfragment("com.erpis.shiperp.sls.parcelsls.fragment.RatePricingColumnListItem", this);
			var oBindingInfo = {
		...
		onShowRateDetail: function () {
			...
			if (!this.oRateDetailDialog) {
				this.oRateDetailDialog = sap.ui.xmlfragment("com.erpis.shiperp.sls.parcelsls.fragment.RateDetailsDialog", this);
				this.getView().addDependent(this.oRateDetailDialog);
			}
			var oObject = sap.ui.getCore().byId("tableRates").getSelectedItem().getBindingContext("local").getObject();
			var oRateDetailTemplate = sap.ui.xmlfragment("com.erpis.shiperp.sls.parcelsls.fragment.RateDetailColumnListItem", this);
			var oBindingInfo = {
		...
		onSerialPress: function () {
			if (!this.oSerialDialog) {
				this.oSerialDialog = sap.ui.xmlfragment("com.erpis.shiperp.sls.parcelsls.fragment.SerialDialog", this);
		...
		_getMessagePopover: function () {
			if (!this._messagePopover) {
				this._messagePopover = sap.ui.xmlfragment("com.erpis.shiperp.sls.parcelsls.fragment.ValidateAddressDialog", this);
			}
		...
		onReprint: function () {
			...
			var oReprintTemplate = sap.ui.xmlfragment("com.erpis.shiperp.sls.parcelsls.fragment.ReprintColumnListItem", this);
			// var oFilter
		...
		onShowFDXGHoldLocationDetail: function () {
			...
			if (!this.oDialogFDXGHoldLocationDetail) {
				this.oDialogFDXGHoldLocationDetail = sap.ui.xmlfragment(
					"com.erpis.shiperp.sls.parcelsls.fragment.carrier.FedExGroundHoldAtLocationDetailDialog",
					this);
		...
		onShowFDXEHoldLocationDetail: function () {
			...
			if (!this.oDialogFDXEHoldLocationDetail) {
				this.oDialogFDXEHoldLocationDetail = sap.ui.xmlfragment(
					"com.erpis.shiperp.sls.parcelsls.fragment.carrier.FedExHoldAtLocationDetailDialog",
					this);
		...
		onShowFDXGCODRecipientDetail: function () {
			...
			if (!this.oDialogCODFDXGRecipientDetail) {
				this.oDialogCODFDXGRecipientDetail = sap.ui.xmlfragment(
					"com.erpis.shiperp.sls.parcelsls.fragment.carrier.FedExGroundCODRecipientDetailDialog",
					this);
		...
		onShowFDXECODRecipientDetail: function () {
			...
			if (!this.oDialogCODFDXERecipientDetail) {
				this.oDialogCODFDXERecipientDetail = sap.ui.xmlfragment(
					"com.erpis.shiperp.sls.parcelsls.fragment.carrier.FedExCODRecipientDetailDialog",
					this);
			...
			this.getModel().create("/ShipmentQuerySet", oRequestData, {
				success: function (oData) {
					...
					if (!this.oRateAnalysisDialog) {
						this.oRateAnalysisDialog = sap.ui.xmlfragment("com.erpis.shiperp.sls.parcelsls.fragment.RateAnalysisDialog", this);
		...
		_getFreightCost: function (sWhichAction) {
			...
			this.getModel().create("/ShipmentQuerySet", oRequestData, {
				success: function (oData) {
					...
					if (!this.oRateDialog) {
						this.oRateDialog = sap.ui.xmlfragment("com.erpis.shiperp.sls.parcelsls.fragment.RatesDialog", this);
		 ...
		 * Execute Ship button
		 * */
		_execute: function (sActionName, iValue) {
			var oRequestData = this._generateExecuteUsecase(sActionName, iValue);
			...
			this.getModel().create("/ShipmentQuerySet", oRequestData, {
				success: function (oData, oResponse) {
					if (oData.showProNum) {
						if (!this.oDialogLTL) {
							this.oDialogLTL = sap.ui.xmlfragment("com.erpis.shiperp.sls.parcelsls.fragment.CreateProNumber", this);
		...
		_generateExecuteUsecase: function (sActionName, iValue) {
			if (!sActionName) {
				sActionName = "Execute";
			}
			var sMPSStatus = this.getModel("local").getProperty("/basic/carrier_data/mps/mps");
