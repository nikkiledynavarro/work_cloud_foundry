sap.ui.define([
	...
	return BaseController.extend("com.erpis.shiperp.closedelivery.hr7.controller.Master", {
		...
		_getListDelivery: function (oValue) {
			var sPath = "/DelivListSet";
			this.getModel().read(sPath, {
				filters: [
					new Filter("vbeln_vl", "EQ", ""),
					new Filter("vbeln_va", "EQ", ""),
					new Filter("bstnk", "EQ", "")
				],
				urlParameters: {
					"$expand": "CloseHeader"
		...
		_showListTemplate: function (oEvent) {
