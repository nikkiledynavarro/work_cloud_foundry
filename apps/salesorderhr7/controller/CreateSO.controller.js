...
sap.ui.define([
	...
	return BaseController.extend("com.erpis.shiperp.salesorder.hr7.controller.CreateSO", {
		oLog: null,
		formatter: formatter,
		...
		onInit: function () {
			...
			this.oLog = Log.getLogger("com.erpis.shiperp.salesorder.hr7.controller.CreateSO");
