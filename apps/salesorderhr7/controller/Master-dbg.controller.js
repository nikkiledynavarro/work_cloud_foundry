...
sap.ui.define([
	...
	return BaseController.extend("com.erpis.shiperp.salesorder.hr7.controller.Master", {
		 ...
		 */
		onInit: function () {
			this.oLog = Log.getLogger("com.erpis.shiperp.salesorder.hr7.controller.Master");
		...
		onMasterFilterChange: function () {
			...
			if (bSoldto) {
				aContainerFilter.push(new Filter("SoldToParty", sap.ui.model.FilterOperator.EQ, this.sCustomer));
			}
			if (bShipto) {
				aContainerFilter.push(new Filter("ShipToParty", sap.ui.model.FilterOperator.EQ, this.sCustomer));
			}
		...
		_applyFilterSearch: function () {
			...
			this._oList.getBinding("items").filter(aFilters1, "Application");
