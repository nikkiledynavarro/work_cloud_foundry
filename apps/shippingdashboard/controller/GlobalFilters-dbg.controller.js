(function () {
	"use strict";
	/*global sap, jQuery */
	jQuery.sap.declare("com.erpis.shiperp.shippingdashboard.controller.GlobalFilters");
	jQuery.sap.require("com.erpis.shiperp.shippingdashboard.controller.BaseController");
	...
	*/
	...
	sap.ui.controller("com.erpis.shiperp.shippingdashboard.controller.GlobalFilters", {
		onInit: function () {
		...
		onBeforeRendering: function () {
			// add logo
			var sRootPath = jQuery.sap.getModulePath("com.erpis.shiperp.shippingdashboard");
...
// 	return BaseController.extend("com.erpis.shiperp.shippingdashboard.controller.GlobalFilters", {
