sap.ui.define([
	...
	"com/erpis/shiperp/freightorderplanning/common/AttachmentUtils",
	"sap/m/MessageBox",
	"sap/m/MessageToast"
	...
	return BaseController.extend("com.erpis.shiperp.freightorderplanning.controller.FreightOrderDetailItem", {
		formatter: formatter,
		/**
		 * Called when a controller is instantiated and its View controls (if available) are already created.
		 * Can be used to modify the View before it is displayed, to bind event handlers and do other one-time initialization.
		 * @memberOf com.erpis.shiperp.freightorderplanning.view.FreightOrderDetailItem
		 */
		onInit: function () {
