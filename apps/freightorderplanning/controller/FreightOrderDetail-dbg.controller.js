sap.ui.define([
	...
	return BaseController.extend("com.erpis.shiperp.freightorderplanning.controller.FreightOrderDetail", {
		formatter: formatter,
		/**
		 * Called when a controller is instantiated and its View controls (if available) are already created.
		 * Can be used to modify the View before it is displayed, to bind event handlers and do other one-time initialization.
		 * @memberOf com.erpis.shiperp.freightorderplanning.view.FreightOrderDetail
		 */
		onInit: function () {
		...
		_onObjectMatched: function (oEvent) {
			...
			// var sPath = jQuery.sap.getModulePath("com.erpis.shiperp.freightorderplanning", "/model/FreightOrderDetail.json");
