...
sap.ui.define([
	...
	return BaseController.extend("com.erpis.shiperp.freightorderplanning.controller.ConditionDetail", {
		...
		onCancelPress: function () {
			...
			MessageBox.confirm(sMsg, {
				...
				onClose: function (oAction) {
					...
					if (isRelease) {
						this._getReversalReason("com.erpis.shiperp.freightorderplanning.fragment.ReversalReasonDialog");
					} else {
						this._cancel("00");
					}
				}.bind(this)
		...
		onStatusClick: function () {
			...
			if (!this._oDialog) { //=== undefined) {
				this._oDialog = sap.ui.xmlfragment("com.erpis.shiperp.freightorderplanning.fragment.StatusDialogDtl", this);
