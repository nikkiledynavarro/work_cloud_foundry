sap.ui.define([
	...
	"sap/ui/model/Filter"
], function (BaseController, Controller, JSONModel, formatter, MessageBox, Utils, Filter) {
	"use strict";

	return BaseController.extend("com.erpis.shiperp.freightorderplanning.controller.Home", {
		...
		onLogin: function () {
			...
			sap.ui.getCore().getModel("global").setProperty("/userProfile", oProfile);
