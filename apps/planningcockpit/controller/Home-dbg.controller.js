sap.ui.define([
	...
	"../model/formatter"
], function (BaseController, JSONModel, MessageBox, Filter, Utils, formatter) {
	"use strict";

	return BaseController.extend("com.erpis.shiperp.planningcockpit.controller.Home", {
		...
		onLogin: function () {
			...
			// 		} else {
			// 			this.hideBusy();
			// 			MessageBox.alert("Please maintain InputType before use this app");
			// 		}
			// 	}.bind(this),
