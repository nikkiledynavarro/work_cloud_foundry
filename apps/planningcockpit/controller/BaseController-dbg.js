...
], function (Controller, UIComponent, mobileLibrary, JSONModel, History, Filter, FilterOperator, MessagePopover, MessagePopoverItem, Link,
	MessageType, MessageBox, BusyIndicator) {
	"use strict";

	return Controller.extend("com.erpis.shiperp.planningcockpit.controller.BaseController", {
		/**
