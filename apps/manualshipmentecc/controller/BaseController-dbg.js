sap.ui.define([
	...
	"sap/ui/core/BusyIndicator",
		"sap/ui/core/library"
], function (Controller, JSONModel, History, Filter, FilterOperator, MessagePopover, MessagePopoverItem, Link, MessageBox,
	BusyIndicator, library) {
	"use strict";

	var MessageType = library.MessageType;

	return Controller.extend("com.erpis.shiperp.manualshipmentecc.controller.BaseController", {
		...
		_MessaePopover: function () {
			...
			if (!this._messagePopover) {
				this._messagePopover = sap.ui.xmlfragment("com.erpis.shiperp.manualshipmentecc.fragment.MessagePopover", this);
			}
