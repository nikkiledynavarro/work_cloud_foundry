(function () {
	"use strict";
	/*global sap, jQuery */
	jQuery.sap.declare("com.erpis.shiperp.shippingdashboardhr7.ext.TrackingShipmentCard.Chart");
	...
	*/
	...
	sap.ui.controller("com.erpis.shiperp.shippingdashboardhr7.ext.TrackingShipmentCard.Chart", {
		...
		onSelectData: function (oEvent) {
			if (!this._oPopover) {
				this._oPopover = sap.ui.xmlfragment("com.erpis.shiperp.shippingdashboardhr7.ext.TrackingShipmentCard.Popover", this);
				this.getView().addDependent(this._oPopover);
			}
			var sCarrier = oEvent.getParameters("data").data[0].data.Carrier;
			var oItemTemplate = sap.ui.xmlfragment("com.erpis.shiperp.shippingdashboardhr7.ext.TrackingShipmentCard.ColumnListItemTemplate", this);
