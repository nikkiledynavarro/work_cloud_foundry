(function () {
	"use strict";
	/*global sap, jQuery */
	jQuery.sap.declare("com.erpis.shiperp.shippingdashboardhr7.ext.InvoiceHeaderStatusCard.Chart");
	...
	jQuery.sap.require("com.erpis.shiperp.shippingdashboardhr7.models.formatter");

	/*
	Here you can put Controller code
	*/

	sap.ui.controller("com.erpis.shiperp.shippingdashboardhr7.ext.InvoiceHeaderStatusCard.Chart", {
		// formatter: formatter,
		onInit: function () {
			var oData = {
				selections: [{
		...
		onSelectData: function (oEvent) {
			if (!this._oInvoiceStatus) {
				this._oInvoiceStatus = sap.ui.xmlfragment("com.erpis.shiperp.shippingdashboardhr7.ext.InvoiceHeaderStatusCard.InvoiceStatus", this);
			...
			var oItemTemplate = sap.ui.xmlfragment("com.erpis.shiperp.shippingdashboardhr7.ext.InvoiceHeaderStatusCard.ColumnListItemTemplate",
				this);
		...
		handleChange: function (oEvent) {
			...
			oListHeaderCard.bindItems({
				path: "MainModel>/xSERPERPxI_SHDB_INV_STAT",
				template: sap.ui.xmlfragment("com.erpis.shiperp.shippingdashboardhr7.ext.InvoiceHeaderStatusCard.HeaderTotalNumber", this),
				parameters: {
