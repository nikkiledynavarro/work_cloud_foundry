...
sap.ui.define([
	...
	return BaseController.extend("com.erpis.shiperp.dispute.hr7.controller.DisputeDetail", {
		...
		onDisputeItemNotePressed: function (oEvent) {
			...
			oUploadCollections.bindItems({
				...
				template: sap.ui.xmlfragment("com.erpis.shiperp.dispute.hr7.fragment.UploadCollectionItemTemplate", this)
			});
