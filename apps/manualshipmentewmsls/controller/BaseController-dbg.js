sap.ui.define([
	...
	return Controller.extend("com.erpis.shiperp.sls.manualewmsls.controller.BaseController", {
		...
		_getMessagePopover: function () {
			if (!this._messagePopover) {
				this._messagePopover = sap.ui.xmlfragment("com.erpis.shiperp.sls.manualewmsls.fragment.MessagePopover", this);
			}
