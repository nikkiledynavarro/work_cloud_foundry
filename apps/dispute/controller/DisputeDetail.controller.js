...
sap.ui.define([
	...
	return BaseController.extend("com.erpis.shiperp.dispute.controller.DisputeDetail", {
		...
		onDisputeItemNotePressed: function (oEvent) {
			...
			oUploadCollections.bindItems({
				...
				template: sap.ui.xmlfragment("com.erpis.shiperp.dispute.fragment.UploadCollectionItemTemplate", this)
			});
