sap.ui.define([
	...
	return BaseController.extend("com.erpis.shiperp.dispute.controller.DisputeList", {

		//Link to "com.erpis.shiperp.dispute.model.formatter" for formatter functions
		formatter: formatter,
		oBundle: null,
		...
		_bindItemsOnTableByServiceUrlAndFilter: function (oTable, sPath, oSorter, aFilters) {
			...
			var oTemplate = sap.ui.xmlfragment("com.erpis.shiperp.dispute.fragment.DisputeListColumnListItem", this);
			this.showBusy();
