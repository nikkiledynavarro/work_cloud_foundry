sap.ui.define([
	...
	return Controller.extend("com.erpis.shiperp.sls.freightauditsls.controller.BaseController", {
		...
		_getMessagePopover: function () {
			if (!this._messagePopover) {
				this._messagePopover = sap.ui.xmlfragment("com.erpis.shiperp.sls.freightauditsls.fragment.MessagePopover", this);
			}
