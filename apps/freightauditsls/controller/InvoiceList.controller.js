sap.ui.define([
	...
	return BaseController.extend("com.erpis.shiperp.sls.freightauditsls.controller.InvoiceList", {
		...
		onCancelButtonPressed: function () {
			...
			if (invoiceExists) {
				this._getReversalReason("com.erpis.shiperp.sls.freightauditsls.fragment.ReversalReasonDialog", "idInvoiceListReversalDialog");
			} else {
		...
		onUpdateStatusButtonPressed: function () {
			...
			if (!this._oDialog) {
				this._oDialog = sap.ui.xmlfragment("com.erpis.shiperp.sls.freightauditsls.fragment.StatusDialogHdr", this);
		...
		onSimulateButtonPressed: function () {
			...
			this.getModel().callFunction("/Simulate", {
				...
				success: function (oData) {
					...
					if (!this._oDialogSim) {
						this._oDialogSim = sap.ui.xmlfragment("com.erpis.shiperp.sls.freightauditsls.fragment.SimulateGrid", this);
		...
		onAPInvoiceNumberButtonPressed: function (oEvent) {
			...
			if (!this._oAPInvoiceNumberDialog) { //=== undefined) {
				this._oAPInvoiceNumberDialog = sap.ui.xmlfragment("com.erpis.shiperp.sls.freightauditsls.fragment.APInvoiceNumberDialog", this);
