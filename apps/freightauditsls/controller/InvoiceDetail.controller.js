/*global location*/
sap.ui.define([
	"com/erpis/shiperp/sls/freightauditsls/controller/BaseController",
	"sap/ui/model/json/JSONModel",
	"sap/ui/core/routing/History",
	"com/erpis/shiperp/sls/freightauditsls/model/formatter",
	"sap/ui/model/Filter",
	"sap/ui/model/FilterOperator",
	"sap/m/MessageToast",
	"sap/m/MessageBox",
	"com/erpis/shiperp/sls/freightauditsls/common/Utils"
], function (BaseController, JSONModel, History, formatter, Filter, FilterOperator, MessageToast, MessageBox, Utils) {
	"use strict";

	return BaseController.extend("com.erpis.shiperp.sls.freightauditsls.controller.InvoiceDetail", {
		...
		onDisputeIDLinkPressed: function (oEvent) {
			...
			var semanticAction = "disputesls-Display"; //Tim added 26/10/2021 Axo 4672 
		...
		onPayamtPress: function (oEvent) {
			...
			if (!this.oPayAmtDialog) {
				this.oPayAmtDialog = sap.ui.xmlfragment("com.erpis.shiperp.sls.freightauditsls.fragment.PayamtUpdate", this);
		...
		onCancelPress: function () {
			...
			// }
			if (isRelease) {
				this._getReversalReason("com.erpis.shiperp.sls.freightauditsls.fragment.ReversalReasonDialog");
			} else {
				this._cancel("00");
			}
			// MessageBox.confirm(sMsg, {
		...
		onOpenShippingPointDialog: function () {
			if (!this.oShippingPointValueHelp) {
				this.oShippingPointValueHelp = sap.ui.xmlfragment("com.erpis.shiperp.sls.freightauditsls.fragment.ShippingPointValueHelp", this);
		...
		onUpdateStatusPress: function () {
			...
			if (!this._oDialog) {
				this._oDialog = sap.ui.xmlfragment("com.erpis.shiperp.sls.freightauditsls.fragment.StatusDialogDtl", this);
				...
				success: function (oData) {
					if (oData.results.length === 0) {
						...
						if (!this._oTrackingDeliveryDialog) {
							this._oTrackingDeliveryDialog = sap.ui.xmlfragment("com.erpis.shiperp.sls.freightauditsls.fragment.TrackingDeliveryDialog",
								this);
