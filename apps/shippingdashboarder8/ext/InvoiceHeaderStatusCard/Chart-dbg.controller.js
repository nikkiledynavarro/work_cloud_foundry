(function () {
	"use strict";
	/*global sap, jQuery */
	jQuery.sap.declare("com.erpis.shiperp.shippingdashboarder8.ext.InvoiceHeaderStatusCard.Chart");
	...
	jQuery.sap.require("com.erpis.shiperp.shippingdashboarder8.models.formatter");

	/*
	Here you can put Controller code
	*/

	sap.ui.controller("com.erpis.shiperp.shippingdashboarder8.ext.InvoiceHeaderStatusCard.Chart", {
		// formatter: formatter,
		onInit: function () {
			var oData = {
				selections: [{
		...
		onSelectData: function (oEvent) {
			if (!this._oInvoiceStatus) {
				this._oInvoiceStatus = sap.ui.xmlfragment("com.erpis.shiperp.shippingdashboarder8.ext.InvoiceHeaderStatusCard.InvoiceStatus", this);
			...
			var oItemTemplate = sap.ui.xmlfragment("com.erpis.shiperp.shippingdashboarder8.ext.InvoiceHeaderStatusCard.ColumnListItemTemplate",
				this);
