/*global location*/
jQuery.sap.require("com.erpis.shiperp.createparcelshipment.common.jquery_hotkeys");
sap.ui.define([
	"com/erpis/shiperp/createparcelshipment/controller/BaseController",
	"sap/ui/model/json/JSONModel",
	"com/erpis/shiperp/createparcelshipment/model/formatter",
	"sap/m/Token",
	"sap/ui/model/Filter",
	"sap/m/MessageBox",
	"sap/m/MessageToast",
	"com/erpis/shiperp/createparcelshipment/common/Utils",
	"com/erpis/shiperp/createparcelshipment/common/hotkeyInterface",
	"com/erpis/shiperp/createparcelshipment/common/DynamicView",
	"com/erpis/shiperp/createparcelshipment/common/UploadUtils",
	"com/erpis/shiperp/createparcelshipment/common/HttpHelper",
	...
	return BaseController.extend("com.erpis.shiperp.createparcelshipment.controller.Main", {
		oLogger: jQuery.sap.log.getLogger("com.erpis.shiperp.createparcelshipment.controller.Main"),
		formatter: formatter,
		...
		onAddDefaultHU: function () {
			if (!this.oDialogDefaultHU) {
				this.oDialogDefaultHU = sap.ui.xmlfragment("com.erpis.shiperp.createparcelshipment.fragment.CreateDefaultHUDialog", this);
		...
		onAddNewHU: function () {
			if (!this.oDialogNewHU) {
				this.oDialogNewHU = sap.ui.xmlfragment("com.erpis.shiperp.createparcelshipment.fragment.CreateHUDialog", this);
			...
			/*
				...
				if (oFreightUnit.isOverviewPack) {
					...
					if (!this._oHUItemsDialog) {
						this._oHUItemsDialog = sap.ui.xmlfragment("com.erpis.shiperp.createparcelshipment.fragment.packing.HUItemsDialog", this);
		...
		onShowPricingDetail: function () {
			...
			if (!this.oRatePricingDialog) {
				this.oRatePricingDialog = sap.ui.xmlfragment("com.erpis.shiperp.createparcelshipment.fragment.RatePricingsDialog", this);
			...
			var oRatePricingTemplate = sap.ui.xmlfragment("com.erpis.shiperp.createparcelshipment.fragment.RatePricingColumnListItem", this);
			var oBindingInfo = {
		...
		onShowRateDetail: function () {
			...
			if (!this.oRateDetailDialog) {
				this.oRateDetailDialog = sap.ui.xmlfragment("com.erpis.shiperp.createparcelshipment.fragment.RateDetailsDialog", this);
				this.getView().addDependent(this.oRateDetailDialog);
			}
			var oObject = sap.ui.getCore().byId("tableRates").getSelectedItem().getBindingContext("local").getObject();
			var oRateDetailTemplate = sap.ui.xmlfragment("com.erpis.shiperp.createparcelshipment.fragment.RateDetailColumnListItem", this);
			var oBindingInfo = {
		...
		onSerialPress: function () {
			if (!this.oSerialDialog) {
				this.oSerialDialog = sap.ui.xmlfragment("com.erpis.shiperp.createparcelshipment.fragment.SerialDialog", this);
		...
		_getMessagePopover: function () {
			if (!this._messagePopover) {
				this._messagePopover = sap.ui.xmlfragment("com.erpis.shiperp.createparcelshipment.fragment.ValidateAddressDialog", this);
			}
		...
		onReprint: function () {
			...
			var oReprintTemplate = sap.ui.xmlfragment("com.erpis.shiperp.createparcelshipment.fragment.ReprintColumnListItem", this);
			// var oFilter
		...
		onShowFDXGHoldLocationDetail: function () {
			...
			if (!this.oDialogFDXGHoldLocationDetail) {
				this.oDialogFDXGHoldLocationDetail = sap.ui.xmlfragment(
					"com.erpis.shiperp.createparcelshipment.fragment.carrier.FedExGroundHoldAtLocationDetailDialog",
					this);
		...
		onShowFDXEHoldLocationDetail: function () {
			...
			if (!this.oDialogFDXEHoldLocationDetail) {
				this.oDialogFDXEHoldLocationDetail = sap.ui.xmlfragment(
					"com.erpis.shiperp.createparcelshipment.fragment.carrier.FedExHoldAtLocationDetailDialog",
					this);
		...
		onShowFDXGCODRecipientDetail: function () {
			...
			if (!this.oDialogCODFDXGRecipientDetail) {
				this.oDialogCODFDXGRecipientDetail = sap.ui.xmlfragment(
					"com.erpis.shiperp.createparcelshipment.fragment.carrier.FedExGroundCODRecipientDetailDialog",
					this);
		...
		onShowFDXECODRecipientDetail: function () {
			...
			if (!this.oDialogCODFDXERecipientDetail) {
				this.oDialogCODFDXERecipientDetail = sap.ui.xmlfragment(
					"com.erpis.shiperp.createparcelshipment.fragment.carrier.FedExCODRecipientDetailDialog",
					this);
			...
			this.getModel().create("/ShipmentQuerySet", oRequestData, {
				success: function (oData) {
					...
					if (!this.oRateAnalysisDialog) {
						this.oRateAnalysisDialog = sap.ui.xmlfragment("com.erpis.shiperp.createparcelshipment.fragment.RateAnalysisDialog", this);
		...
		_getFreightCost: function (sWhichAction) {
			...
			this.getModel().create("/ShipmentQuerySet", oRequestData, {
				success: function (oData) {
					...
					if (!this.oRateDialog) {
						this.oRateDialog = sap.ui.xmlfragment("com.erpis.shiperp.createparcelshipment.fragment.RatesDialog", this);
					...
					if (oData.Custom_Fields !== null) {
						if (oData.Custom_Fields) {
							...
							if (!this.oShipmentAddrValid) {
								this.oShipmentAddrValid = sap.ui.xmlfragment("com.erpis.shiperp.createparcelshipment.fragment.ShipmentAddressValidation", this);
						...
						if (!this.oTrackNumbersDlg) {
							this.oTrackNumbersDlg = sap.ui.xmlfragment("com.erpis.shiperp.createparcelshipment.fragment.tracking.TrackingNumbers", this);
						...
						if (oData.showProNum) {
							if (!this.oDialogLTL) {
								this.oDialogLTL = sap.ui.xmlfragment("com.erpis.shiperp.createparcelshipment.fragment.CreateProNumber", this);
