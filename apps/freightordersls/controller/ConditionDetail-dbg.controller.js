...
sap.ui.define([
	...
	return BaseController.extend("com.erpis.shiperp.sls.freightordersls.controller.ConditionDetail", {
		...
		onCancelPress: function () {
			...
			MessageBox.confirm(sMsg, {
				...
				onClose: function (oAction) {
					...
					if (isRelease) {
						this._getReversalReason("com.erpis.shiperp.sls.freightordersls.fragment.ReversalReasonDialog");
					} else {
						this._cancel("00");
					}
				}.bind(this)
		...
		onStatusClick: function () {
			...
			if (!this._oDialog) { //=== undefined) {
				this._oDialog = sap.ui.xmlfragment("com.erpis.shiperp.sls.freightordersls.fragment.StatusDialogDtl", this);
