/*global location*/
jQuery.sap.require("com.erpis.shiperp.parcel.hd6.common.jquery_hotkeys");
sap.ui.define([
	...
	"com/erpis/shiperp/parcel/hd6/common/hotkeyInterface"
], function (BaseController, JSONModel, formatter, Token, Filter, MessageBox, MessageToast, Utils, HotkeyInterface) {
	"use strict";

	return BaseController.extend("com.erpis.shiperp.parcel.hd6.controller.Main", {

		oLogger: jQuery.sap.log.getLogger("com.erpis.shiperp.parcel.hd6.controller.Main"),
		formatter: formatter,
		...
		onAddDefaultHU: function () {
			if (!this.oDialogDefaultHU) {
				this.oDialogDefaultHU = sap.ui.xmlfragment("com.erpis.shiperp.parcel.hd6.fragment.CreateDefaultHUDialog", this);
		...
		onAddNewHU: function () {
			if (!this.oDialogNewHU) {
				this.oDialogNewHU = sap.ui.xmlfragment("com.erpis.shiperp.parcel.hd6.fragment.CreateHUDialog", this);
		...
		onOpenHUItemsDialog: function (oEvent) {
			...
			if (!this._oHUItemsDialog) {
				this._oHUItemsDialog = sap.ui.xmlfragment("com.erpis.shiperp.parcel.hd6.fragment.packing.HUItemsDialog", this);
		...
		onShowPricingDetail: function () {
			...
			if (!this.oRatePricingDialog) {
				this.oRatePricingDialog = sap.ui.xmlfragment("com.erpis.shiperp.parcel.hd6.fragment.RatePricingsDialog", this);
			...
			var oRatePricingTemplate = sap.ui.xmlfragment("com.erpis.shiperp.parcel.hd6.fragment.RatePricingColumnListItem", this);
			var oBindingInfo = {
		...
		onShowRateDetail: function () {
			...
			if (!this.oRateDetailDialog) {
				this.oRateDetailDialog = sap.ui.xmlfragment("com.erpis.shiperp.parcel.hd6.fragment.RateDetailsDialog", this);
				this.getView().addDependent(this.oRateDetailDialog);
			}
			var oObject = sap.ui.getCore().byId("tableRates").getSelectedItem().getBindingContext("local").getObject();
			var oRateDetailTemplate = sap.ui.xmlfragment("com.erpis.shiperp.parcel.hd6.fragment.RateDetailColumnListItem", this);
			var oBindingInfo = {
		...
		onSerialPress: function () {
			if (!this.oSerialDialog) {
				this.oSerialDialog = sap.ui.xmlfragment("com.erpis.shiperp.parcel.hd6.fragment.SerialDialog", this);
		...
		onReprint: function () {
			...
			var oReprintTemplate = sap.ui.xmlfragment("com.erpis.shiperp.parcel.hd6.fragment.ReprintColumnListItem", this);
			// var oFilter
		...
		onShowFDXGHoldLocationDetail: function () {
			...
			if (!this.oDialogFDXGHoldLocationDetail) {
				this.oDialogFDXGHoldLocationDetail = sap.ui.xmlfragment(
					"com.erpis.shiperp.parcel.hd6.fragment.carrier.FedExGroundHoldAtLocationDetailDialog",
					this);
		...
		onShowFDXEHoldLocationDetail: function () {
			...
			if (!this.oDialogFDXEHoldLocationDetail) {
				this.oDialogFDXEHoldLocationDetail = sap.ui.xmlfragment(
					"com.erpis.shiperp.parcel.hd6.fragment.carrier.FedExHoldAtLocationDetailDialog",
					this);
		...
		onShowFDXGCODRecipientDetail: function () {
			...
			if (!this.oDialogCODFDXGRecipientDetail) {
				this.oDialogCODFDXGRecipientDetail = sap.ui.xmlfragment(
					"com.erpis.shiperp.parcel.hd6.fragment.carrier.FedExGroundCODRecipientDetailDialog",
					this);
		...
		onShowFDXECODRecipientDetail: function () {
			...
			if (!this.oDialogCODFDXERecipientDetail) {
				this.oDialogCODFDXERecipientDetail = sap.ui.xmlfragment(
					"com.erpis.shiperp.parcel.hd6.fragment.carrier.FedExCODRecipientDetailDialog",
					this);
			...
			this.getModel().create("/ShipmentQuerySet", oRequestData, {
				success: function (oData) {
					...
					if (!this.oRateAnalysisDialog) {
						this.oRateAnalysisDialog = sap.ui.xmlfragment("com.erpis.shiperp.parcel.hd6.fragment.RateAnalysisDialog", this);
		...
		_getFreightCost: function (sWhichAction) {
			...
			this.getModel().create("/ShipmentQuerySet", oRequestData, {
				success: function (oData) {
					...
					if (!this.oRateDialog) {
						this.oRateDialog = sap.ui.xmlfragment("com.erpis.shiperp.parcel.hd6.fragment.RatesDialog", this);
