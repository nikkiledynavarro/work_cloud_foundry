sap.ui.define(["sap/ui/layout/form/SimpleForm", "com/erpis/shiperp/manualshipmentewm/hr7/common/ControlUtils",
		...
		renderMoreOptionFormContent: function (aOriginalSourceFields, oController, bDeep, bShipment, oDataOld) {
			...
			if (aSourceFields.length > 0) {
				...
				for (var i = 0; i < aSourceFields.length; i++) {
					...
					//Axo 4770
					if (oController.bShipment === false) {
					...
					if (aSourceFields[i].field_value2 !== "") {
						...
						oController.oTable = new sap.m.Table({
						...
						aData.value.forEach(function (obj, index) {
							...
							oController.oTable.addItem(oRow);
						});
						...
						var oSearchField = new sap.m.SearchField({
							...
							liveChange: function (oEvent) {
								...
								var aItems = oController.oTable.getItems();
						...
						var oVBoxTable = new sap.m.VBox({
							items: [oToolbar, oController.oTable]
						});
					}
				} //end loop
