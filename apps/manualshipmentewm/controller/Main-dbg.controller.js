/*global location*/
jQuery.sap.require("com.erpis.shiperp.manualshipmentewm.hr7.common.jquery_hotkeys");
sap.ui.define([
	"com/erpis/shiperp/manualshipmentewm/hr7/controller/BaseController",
	"sap/ui/model/json/JSONModel",
	"com/erpis/shiperp/manualshipmentewm/hr7/model/formatter",
	"sap/m/Token",
	"sap/ui/model/Filter",
	"sap/m/MessageBox",
	"sap/m/MessageToast",
	"com/erpis/shiperp/manualshipmentewm/hr7/common/Utils",
	"com/erpis/shiperp/manualshipmentewm/hr7/common/hotkeyInterface",
	"com/erpis/shiperp/manualshipmentewm/hr7/common/DynamicView",
	"com/erpis/shiperp/manualshipmentewm/hr7/common/UploadUtils",
	"com/erpis/shiperp/manualshipmentewm/hr7/common/HttpHelper",
	"sap/ui/core/library"
	...
	return BaseController.extend("com.erpis.shiperp.manualshipmentewm.hr7.controller.Main", {

		oLogger: jQuery.sap.log.getLogger("com.erpis.shiperp.manualshipmentewm.hr7.controller.Main"),
		formatter: formatter,
		...
		onInit: function () {
			...
			var oViewModel = new JSONModel({
				...
				isOnlyOneSelectedContents: false,
				Header: {
					ServiceName: "",
					ShipToCountry: "",
					ShipToState: "",
		...
		_onObjectMatched: function (oEvent) {
			...
			this.byId("iconTabPacking").setBusy(true);
			...
			$.when(oDeferredMoreInfor, this.oInputTypeDeferred).done(function (oData) {
				this.getModel("local").setProperty("/Shipped", true);
				this.byId("iconTabPacking").setBusy(false);
				...
				success: function (oData) {
					...
					if (oData.hazmat_err_hu && oData.hazmat_err_hu.results.length > 0) {
						...
						if (!this.ohazmaterrhuDialog) {
							this.ohazmaterrhuDialog = sap.ui.xmlfragment("com.erpis.shiperp.manualshipmentewm.hr7.fragment.Shipmentcontainshazmat", this);
		...
		onDisplayReport: function () {
			if (!this.onOpenReport) {
				this.onOpenReport = sap.ui.xmlfragment("com.erpis.shiperp.manualshipmentewm.hr7.fragment.ReportHazmatMaterial", this);
		...
		onSelectionChangeContents: function (oEvent) {
			var aSelected = oEvent.getSource().getSelectedItems();
			if (aSelected.length === 0) {
				this.getModel("local").setProperty("/isOnlyOneSelectedContents", false);
			} else {
				this.getModel("local").setProperty("/isOnlyOneSelectedContents", true);
			}
		},
		...
		onAddDefaultHU: function () {
			if (!this.oDialogDefaultHU) {
				this.oDialogDefaultHU = sap.ui.xmlfragment("com.erpis.shiperp.manualshipmentewm.hr7.fragment.CreateDefaultHUDialog", this);
		...
		onAddNewHU: function () {
			...
			if (!this.oDialogNewHU) {
				this.oDialogNewHU = sap.ui.xmlfragment("com.erpis.shiperp.manualshipmentewm.hr7.fragment.CreateHUDialog", this);
		...
		onShowPricingDetail: function () {
			...
			if (!this.oRatePricingDialog) {
				this.oRatePricingDialog = sap.ui.xmlfragment("com.erpis.shiperp.manualshipmentewm.hr7.fragment.RatePricingsDialog", this);
			...
			var oRatePricingTemplate = sap.ui.xmlfragment("com.erpis.shiperp.manualshipmentewm.hr7.fragment.RatePricingColumnListItem", this);
			var oBindingInfo = {
			...
			this.getModel().create("/ShipmentQuerySet", oRequestData, {
				success: function (oData) {
					...
					if (!this.oRateAnalysisDialog) {
						this.oRateAnalysisDialog = sap.ui.xmlfragment("com.erpis.shiperp.manualshipmentewm.hr7.fragment.RateAnalysisDialog", this);
			...
			this.getModel().create("/ShipmentQuerySet", oRequestData, {
				success: function (oData) {
					...
					if (!this.oConditionTablesDialog) {
						this.oConditionTablesDialog = sap.ui.xmlfragment("com.erpis.shiperp.manualshipmentewm.hr7.fragment.ConditionTablesDialog",
							this);
		...
		onShowRateDetail: function () {
			...
			if (!this.oRateDetailDialog) {
				this.oRateDetailDialog = sap.ui.xmlfragment("com.erpis.shiperp.manualshipmentewm.hr7.fragment.RateDetailsDialog", this);
				this.getView().addDependent(this.oRateDetailDialog);
			}
			var oObject = sap.ui.getCore().byId("tableRates").getSelectedItem().getBindingContext("local").getObject();
			var oRateDetailTemplate = sap.ui.xmlfragment("com.erpis.shiperp.manualshipmentewm.hr7.fragment.RateDetailColumnListItem", this);
			var oBindingInfo = {
		...
		onSerialPress: function () {
			if (!this.oSerialDialog) {
				this.oSerialDialog = sap.ui.xmlfragment("com.erpis.shiperp.manualshipmentewm.hr7.fragment.SerialDialog", this);
		...
		onHUTableUpdateFinished: function (oEvent) {
			...
			// Mark shipment as incomplete (true) if any HU has no Trackingnumber
			this._updateShippingStatus(aSelected);
		},

		onUpdateFinishedContens: function (oEvent) {
		...
		onReprint: function () {
			...
			var oReprintTemplate = sap.ui.xmlfragment("com.erpis.shiperp.manualshipmentewm.hr7.fragment.ReprintColumnListItem", this);
			// var oFilter
		...
		*/
		...
		onShowFDXGHoldLocationDetail: function () {
			...
			if (!this.oDialogFDXGHoldLocationDetail) {
				this.oDialogFDXGHoldLocationDetail = sap.ui.xmlfragment(
					"com.erpis.shiperp.manualshipmentewm.hr7.fragment.carrier.FedExGroundHoldAtLocationDetailDialog",
					this);
		...
		onShowFDXEHoldLocationDetail: function () {
			...
			if (!this.oDialogFDXEHoldLocationDetail) {
				this.oDialogFDXEHoldLocationDetail = sap.ui.xmlfragment(
					"com.erpis.shiperp.manualshipmentewm.hr7.fragment.carrier.FedExHoldAtLocationDetailDialog",
					this);
		...
		onShowFDXGCODRecipientDetail: function () {
			...
			if (!this.oDialogCODFDXGRecipientDetail) {
				this.oDialogCODFDXGRecipientDetail = sap.ui.xmlfragment(
					"com.erpis.shiperp.manualshipmentewm.hr7.fragment.carrier.FedExGroundCODRecipientDetailDialog",
					this);
		...
		onShowFDXECODRecipientDetail: function () {
			...
			if (!this.oDialogCODFDXERecipientDetail) {
				this.oDialogCODFDXERecipientDetail = sap.ui.xmlfragment(
					"com.erpis.shiperp.manualshipmentewm.hr7.fragment.carrier.FedExCODRecipientDetailDialog",
					this);
		...
		_getFreightCost: function (sWhichAction) {
			...
			this.getModel().create("/ShipmentQuerySet", oRequestData, {
				success: function (oData) {
					...
					if (!this.oRateDialog) {
						this.oRateDialog = sap.ui.xmlfragment("com.erpis.shiperp.manualshipmentewm.hr7.fragment.RatesDialog", this);
		...
		_generateMessageObject: function (oPassMessage) {
			...
			case "E":
				oMessage.type = library.MessageType.Error;
				break;
			case "W":
				oMessage.type = library.MessageType.Warning;
				break;
			case "I":
				oMessage.type = library.MessageType.Information;
				break;
			case "S":
				oMessage.type = library.MessageType.Success;
				break;
			default:
				oMessage.type = library.MessageType.Warning;
				break;
			...
			this.getModel().create("/ShipmentQuerySet", oRequestData, {
				success: function (oData, oResponse) {
					...
					var oPreviousShipment = {
						carrier: oBasic.carrier_data.carrier,
						service: oBasic.carrier_data.service,
						billing_option: oBasic.payment.billing_option,
						shipment_date: oBasic.date_time.shipment_date,
		...
		_generateExecuteUsecase: function () {
			var sMPSType = this.getModel("local").getProperty("/basic/carrier_data/mps/mpstype");
			var shipContents = this.getModel("local").getProperty("/aManshipContents");
			var aSelectedItems = this.oHUTable.getSelectedItems();
			var aHUs = this._handleHUSPayload(this.getModel("local").getProperty("/HUS"));
			...
			var aCarrierOption = this.getModel("local").getProperty("/ShipmentCarrierOptions");
			if (aCarrierOption.length > 0) {
				aCarrierOption.forEach(function (item) {
					if (typeof item.field_value2 !== "string") {
						item.field_value2 = JSON.stringify(item.field_value2);
						item.search_help = JSON.stringify(item.search_help);
					}
			...
			var oData = {
				...
				FreightUnitExtSet: aFreightUnitExt,
				basic: this.getModel("local").getProperty("/basic"),
				carrier_more_option: (aCarrierOption) ? aCarrierOption : [{
					value_list: []
				}],
				HUS: this.getModel("local").getProperty("/HUS"),
				HTS: this.getModel("local").getProperty("/HTS"),
				References: this.getModel("local").getProperty("/References"),
				ShipmentReturnSet: [],
				return: [],
		...
		_updateShippingStatus: function (aSelected) {
			//  Enable shipment process
			var bShipped = false;
			var aHandlingUnits = this.getModel("local").getProperty("/HUS") || [];
			if (aHandlingUnits.length > 0) {
				var bShipped = aHandlingUnits.reduce(function (acc, item) {
					return acc && !!item.Trackingnumber && item.Trackingnumber.trim() !== "";
				}, true);
			}
			this.getModel("local").setProperty("/Shipped", !bShipped);
			// Enable Button process HUs
		...
		_updateHazmatChange: function (oBinding) {
			...
			oData.Packagetype = this.byId("cbPackType").getSelectedKey();
			this.getModel("local").setProperty(sPath, oData);
		},
		...
		_generateShipmentCarrierMoreOption: function (aShipmentCarrierMoreOptions, oContainer) {
			...
			var oCurrForm = this.oShipmentCarrierOptionTab.getBlocks()[0];
			if (oCurrForm) {
				if (typeof oCurrForm.removeAllContent === 'function') {
					oCurrForm.removeAllContent();
				} else {
					oCurrForm.getItems()[0].removeAllContent();
				}
			}
			this.oShipmentCarrierOptionTab.removeAllBlocks();
		...
		getFinalShipmentCarrierOptionData: function (oShipmentCarrierOptionContainer) {
			if (oShipmentCarrierOptionContainer.getBlocks().length > 0) {
				var acheckCarrierMoreOptionsForm = oShipmentCarrierOptionContainer.getBlocks()[0];
				var aCarrierMoreOptionsForm;
				if (acheckCarrierMoreOptionsForm) {
					if (typeof acheckCarrierMoreOptionsForm.removeAllContent === 'function') {
						aCarrierMoreOptionsForm = acheckCarrierMoreOptionsForm;
					} else {
						aCarrierMoreOptionsForm = acheckCarrierMoreOptionsForm.getItems()[0];
					}
				}
		...
		_generateShipmentInterNationOptions: function (aShipmentInternationOption, oContainer) {
			...
			//add prefix before process
			this.bShipment = this.getModel("local").getProperty("/Shipped");
			...
			this.getModel().create("/ShipmentQuerySet", oRequestData, {
				success: function (oData) {
					if (oData.return && oData.return.results.length > 0) {
						...
						this._addMessage(aMsg);
						if (aMsg.length > 0) this.byId('popoverButton').firePress();
						var shiptos = oData.return.results[0].MessageV1;
