sap.ui.define([
	...
	return Controller.extend("com.erpis.shiperp.hr7.ltlplanning.controller.BaseController", {
		...
		_getMessagePopover: function () {
			if (!this._messagePopover) {
				this._messagePopover = sap.ui.xmlfragment("com.erpis.shiperp.hr7.ltlplanning.fragment.MessagePopover", this);
			}
		...
		treeify: function (list, idAttr, parentAttr, childrenAttr) {
			if (!idAttr) idAttr = 'Node';
			if (!parentAttr) parentAttr = 'ParentNode';
