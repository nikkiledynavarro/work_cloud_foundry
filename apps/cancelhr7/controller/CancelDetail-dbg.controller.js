sap.ui.define([
	"com/erpis/shiperp/cancel/hr7/controller/BaseController",
	"sap/ui/model/json/JSONModel",
	"sap/ui/core/routing/History",
	"com/erpis/shiperp/cancel/hr7/model/formatter",
	"sap/ui/model/Filter",
	...
	return BaseController.extend("com.erpis.shiperp.cancel.hr7.controller.CancelDetail", {
		/* =========================================================== */
		/* Global variables for this view                              */
		/* =========================================================== */

		//Link to "com.erpis.shiperp.cancel.hr7.model.formatter" for formatter functions
		formatter: formatter,
		oBundle: null,
		sShipStation: "",
		sProfile: "",
		...
		onInit: function () {
			...
			this.getRouter().getRoute("cancelDetail").attachPatternMatched(this._onObjectMatched, this);
		...
		/* =========================================================== */
		onCancel: function () {
			var oTab = this.byId("idTrackproTab");
		...
		onTabUpdateFinished: function (oEvent) {
		...
		_cancel: function (sDocType, sDocTypeDesc, sID, aItems) {
			...
			for (var i = 0; i < aItems.length; i++) {
				...
				this.getModel().callFunction("/CancelShipment", {
					method: "POST",
					urlParameters: {
			...
			this.getModel().submitChanges({
				...
				success: function (oData) {
					...
					if (this.bAllItemSelected) {
						this.byId("idTrackproTab").removeAllItems();
						this.byId("idIDInp").setValue("");
					} else {
		...
		_getFreghUnits: function (sDocType, sID) {
			this.getModel().callFunction("/GetFreightUnits", {
				method: "GET",
				urlParameters: {
					DocType: sDocType,
					IDs: sID
				...
				success: function (oData) {
					this.byId("idTrackproTab").removeSelections();
