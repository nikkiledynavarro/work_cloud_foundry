sap.ui.define([
	...
	return Controller.extend("com.erpis.shiperp.sls.shipewmsls.controller.BaseController", {
		...
		_getMessagePopover: function () {
			if (!this._messagePopover) {
				this._messagePopover = sap.ui.xmlfragment("com.erpis.shiperp.sls.shipewmsls.fragment.MessagePopover", this);
			}
		...
		treeify: function (list, idAttr, parentAttr, childrenAttr) {
			...
			list.forEach(function (obj) {
				if (obj[parentAttr].trim() === "" || obj[parentAttr].trim() === 0) {
					treeList.push(obj);
				} else {
