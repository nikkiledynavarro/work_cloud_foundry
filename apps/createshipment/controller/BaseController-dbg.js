sap.ui.define([
	...
	return Controller.extend("com.erpis.shiperp.parcel.hr7.controller.BaseController", {
		...
		_MessaePopover: function () {
			...
			if (!this._messagePopover) {
				this._messagePopover = sap.ui.xmlfragment("com.erpis.shiperp.parcel.hr7.fragment.MessagePopover", this);
			}
