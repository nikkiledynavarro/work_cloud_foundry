sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("com/erpis/shiperp/freightorder/app", ".html");
		...
		return Opa5.extend("com.erpis.shiperp.freightorder.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["com/erpis/shiperp/freightorder/localService/mockserver"], function (mockserver) {
