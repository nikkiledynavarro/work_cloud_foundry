...
sap.ui.define([
	...
	return BaseController.extend("com.erpis.shiperp.freightorder.controller.ConditionDetail", {
		...
		onCancelPress: function () {
			...
			MessageBox.confirm(sMsg, {
				...
				onClose: function (oAction) {
					...
					if (isRelease) {
						this._getReversalReason("com.erpis.shiperp.freightorder.fragment.ReversalReasonDialog");
					} else {
						this._cancel("00");
					}
				}.bind(this)
		...
		onStatusClick: function () {
			...
			if (!this._oDialog) { //=== undefined) {
				this._oDialog = sap.ui.xmlfragment("com.erpis.shiperp.freightorder.fragment.StatusDialogDtl", this);
