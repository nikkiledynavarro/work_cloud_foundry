sap.ui.define([
	...
	return Controller.extend("com.erpis.shiperp.freightorder.controller.BaseController", {
		...
		_getMessagePopover: function () {
			if (!this._messagePopover) {
				this._messagePopover = sap.ui.xmlfragment("com.erpis.shiperp.freightorder.fragment.MessagePopover", this);
			}
