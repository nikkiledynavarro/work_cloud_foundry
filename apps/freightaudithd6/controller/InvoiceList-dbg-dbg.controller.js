sap.ui.define([
	...
	return BaseController.extend("com.erpis.shiperp.freightaudit.hd6.hr7.controller.InvoiceList", {
			...
			MessageBox.confirm(sMsg, {
				...
				onClose: function (oAction) {
					if (oAction === MessageBox.Action.OK) {
						...
						if (invoiceExists) {
							this._getReversalReason("com.erpis.shiperp.freightaudit.hd6.hr7.fragment.ReversalReasonDialog", "idInvoiceListReversalDialog");
						} else {
		...
		onUpdateStatusButtonPressed: function () {
			...
			if (!this._oDialog) {
				this._oDialog = sap.ui.xmlfragment("com.erpis.shiperp.freightaudit.hd6.hr7.fragment.StatusDialogHdr", this);
		...
		onSimulateButtonPressed: function () {
			...
			this.getModel().callFunction("/Simulate", {
				...
				success: function (oData) {
					...
					if (!this._oDialogSim) {
						this._oDialogSim = sap.ui.xmlfragment("com.erpis.shiperp.freightaudit.hd6.hr7.fragment.SimulateGrid", this);
		...
		onAPInvoiceNumberButtonPressed: function (oEvent) {
			...
			if (!this._oAPInvoiceNumberDialog) { //=== undefined) {
				this._oAPInvoiceNumberDialog = sap.ui.xmlfragment("com.erpis.shiperp.freightaudit.hd6.hr7.fragment.APInvoiceNumberDialog", this);
