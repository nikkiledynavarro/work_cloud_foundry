		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#ShipmentPlanning-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ShipmentPlanning-display": {
								"semanticObject": "ShipmentPlanning",
								"action": "display",
								"description": "Shipment Planning",
								"title": "Shipment Planning",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.erpis.shiperp.planning",
									"url": sap.ui.require.toUrl("com/erpis/shiperp/planning/Planning")
								}
							}
						}
					}
