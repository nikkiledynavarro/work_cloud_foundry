/*global location*/
jQuery.sap.require("com.erpis.shiperp.planning.common.jquery_hotkeys");
sap.ui.define([
	"com/erpis/shiperp/planning/controller/BaseController",
	"sap/ui/model/json/JSONModel",
	"com/erpis/shiperp/planning/model/formatter",
	"sap/m/Token",
	"sap/ui/model/Filter",
	"sap/m/MessageBox",
	"sap/m/MessageToast",
	"com/erpis/shiperp/planning/common/Utils",
	"com/erpis/shiperp/planning/common/hotkeyInterface"
], function (BaseController, JSONModel, formatter, Token, Filter, MessageBox, MessageToast, Utils, HotkeyInterface) {
	"use strict";

	return BaseController.extend("com.erpis.shiperp.planning.controller.Main", {

		oLogger: jQuery.sap.log.getLogger("com.erpis.shiperp.planning.controller.Main"),
		formatter: formatter,
		...
		onAddDefaultHU: function () {
			if (!this.oDialogDefaultHU) {
				this.oDialogDefaultHU = sap.ui.xmlfragment("com.erpis.shiperp.planning.fragment.CreateDefaultHUDialog", this);
		...
		onAddNewHU: function () {
			if (!this.oDialogNewHU) {
				this.oDialogNewHU = sap.ui.xmlfragment("com.erpis.shiperp.planning.fragment.CreateHUDialog", this);
		...
		onBtnPressRefChange: function () {
			this._oRefDialog = Utils.getFragment("", "planning.DialogRefDisplay", this);
		...
		onOpenHUItemsDialog: function (oEvent) {
			...
			if (!this._oHUItemsDialog) {
				this._oHUItemsDialog = sap.ui.xmlfragment("com.erpis.shiperp.planning.fragment.packing.HUItemsDialog", this);
		...
		onShowPricingDetail: function () {
			...
			if (!this.oRatePricingDialog) {
				this.oRatePricingDialog = sap.ui.xmlfragment("com.erpis.shiperp.planning.fragment.RatePricingsDialog", this);
			...
			var oRatePricingTemplate = sap.ui.xmlfragment("com.erpis.shiperp.planning.fragment.RatePricingColumnListItem", this);
			var oBindingInfo = {
		...
		onShowRateDetail: function () {
			...
			if (!this.oRateDetailDialog) {
				this.oRateDetailDialog = sap.ui.xmlfragment("com.erpis.shiperp.planning.fragment.RateDetailsDialog", this);
				this.getView().addDependent(this.oRateDetailDialog);
			}
			var oObject = sap.ui.getCore().byId("tableRates").getSelectedItem().getBindingContext("local").getObject();
			var oRateDetailTemplate = sap.ui.xmlfragment("com.erpis.shiperp.planning.fragment.RateDetailColumnListItem", this);
			var oBindingInfo = {
		...
		onSerialPress: function () {
			if (!this.oSerialDialog) {
				this.oSerialDialog = sap.ui.xmlfragment("com.erpis.shiperp.planning.fragment.SerialDialog", this);
		...
		onReprint: function () {
			...
			var oReprintTemplate = sap.ui.xmlfragment("com.erpis.shiperp.planning.fragment.ReprintColumnListItem", this);
			// var oFilter
		...
		onShowFDXGHoldLocationDetail: function () {
			...
			if (!this.oDialogFDXGHoldLocationDetail) {
				this.oDialogFDXGHoldLocationDetail = sap.ui.xmlfragment(
					"com.erpis.shiperp.planning.fragment.carrier.FedExGroundHoldAtLocationDetailDialog",
					this);
		...
		onShowFDXEHoldLocationDetail: function () {
			...
			if (!this.oDialogFDXEHoldLocationDetail) {
				this.oDialogFDXEHoldLocationDetail = sap.ui.xmlfragment(
					"com.erpis.shiperp.planning.fragment.carrier.FedExHoldAtLocationDetailDialog",
					this);
		...
		onShowFDXGCODRecipientDetail: function () {
			...
			if (!this.oDialogCODFDXGRecipientDetail) {
				this.oDialogCODFDXGRecipientDetail = sap.ui.xmlfragment(
					"com.erpis.shiperp.planning.fragment.carrier.FedExGroundCODRecipientDetailDialog",
					this);
		...
		onShowFDXECODRecipientDetail: function () {
			...
			if (!this.oDialogCODFDXERecipientDetail) {
				this.oDialogCODFDXERecipientDetail = sap.ui.xmlfragment(
					"com.erpis.shiperp.planning.fragment.carrier.FedExCODRecipientDetailDialog",
					this);
		...
		onCreateFreightOrderDialog: function () {
			if (!this.oDialogCreateFreightOrder) {
				this.oDialogCreateFreightOrder = sap.ui.xmlfragment("com.erpis.shiperp.planning.fragment.packing.CreateFreightOrder", this);
		...
		onUpdateRoutingDialog: function () {
			if (!this.oDialogUpdateRouting) {
				this.oDialogUpdateRouting = sap.ui.xmlfragment("com.erpis.shiperp.planning.fragment.packing.UpdateRouting", this);
		...
		onRequestRoutingDialog: function () {
			if (!this.oDialogRequestRouting) {
				this.oDialogRequestRouting = sap.ui.xmlfragment("com.erpis.shiperp.planning.fragment.packing.RequestRouting", this);
		...
		onRequestForPickupDialog: function () {
			if (!this.oDialogRequestForPickup) {
				this.oDialogRequestForPickup = sap.ui.xmlfragment("com.erpis.shiperp.planning.fragment.packing.RequestForPickup", this);
			...
			this.getModel().create("/ShipmentQuerySet", oRequestData, {
				success: function (oData) {
					...
					if (!this.oRateAnalysisDialog) {
						this.oRateAnalysisDialog = sap.ui.xmlfragment("com.erpis.shiperp.planning.fragment.RateAnalysisDialog", this);
		...
		_getFreightCost: function (sWhichAction) {
			...
			this.getModel().create("/ShipmentQuerySet", oRequestData, {
				success: function (oData) {
					...
					if (!this.oRateDialog) {
						this.oRateDialog = sap.ui.xmlfragment("com.erpis.shiperp.planning.fragment.RatesDialog", this);
