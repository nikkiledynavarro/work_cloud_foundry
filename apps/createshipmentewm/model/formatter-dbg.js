sap.ui.define([], function () {
	...
	return {
		...
		getTransparentLogoLink: function (sDummy) {
			var sRootPath = jQuery.sap.getModulePath("com.erpis.shiperp.createshipmentewm");
		...
		highlightHu: function (aItems, sTracking) {
			if (sTracking && sTracking.trim() !== "") {
				return "Success";
			}

			if (aItems && aItems.results && aItems.results.length > 0) {
				return "Information";
			}
