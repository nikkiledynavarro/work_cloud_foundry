/*global location*/
jQuery.sap.require("com.erpis.shiperp.createshipmentewm.common.jquery_hotkeys");
sap.ui.define([
	"com/erpis/shiperp/createshipmentewm/controller/BaseController",
	"sap/ui/model/json/JSONModel",
	"com/erpis/shiperp/createshipmentewm/model/formatter",
	"sap/m/Token",
	"sap/ui/model/Filter",
	"sap/m/MessageBox",
	"sap/m/MessageToast",
	"com/erpis/shiperp/createshipmentewm/common/Utils",
	"com/erpis/shiperp/createshipmentewm/common/hotkeyInterface",
	"com/erpis/shiperp/createshipmentewm/common/DynamicView",
	"com/erpis/shiperp/createshipmentewm/common/UploadUtils",
	"com/erpis/shiperp/createshipmentewm/common/HttpHelper",
	...
	return BaseController.extend("com.erpis.shiperp.createshipmentewm.controller.Main", {

		oLogger: jQuery.sap.log.getLogger("com.erpis.shiperp.createshipmentewm.controller.Main"),
		formatter: formatter,
						...
						this._checkAutoCheck().done(function () {
							...
							if (oData.hazmat_err_hu && oData.hazmat_err_hu.results.length > 0) {
								...
								if (!this.ohazmaterrhuDialog) {
									this.ohazmaterrhuDialog = sap.ui.xmlfragment("com.erpis.shiperp.createshipmentewm.fragment.Shipmentcontainshazmat", this);
		...
		onDisplayReport: function () {
			if (!this.onOpenReport) {
				this.onOpenReport = sap.ui.xmlfragment("com.erpis.shiperp.createshipmentewm.fragment.ReportHazmatMaterial", this);
		...
		onAddDefaultHU: function () {
			if (!this.oDialogDefaultHU) {
				this.oDialogDefaultHU = sap.ui.xmlfragment("com.erpis.shiperp.createshipmentewm.fragment.CreateDefaultHUDialog", this);
		...
		onAddNewHU: function () {
			...
			if (!this.oDialogNewHU) {
				this.oDialogNewHU = sap.ui.xmlfragment("com.erpis.shiperp.createshipmentewm.fragment.CreateHUDialog", this);
		...
		onShowPricingDetail: function () {
			...
			if (!this.oRatePricingDialog) {
				this.oRatePricingDialog = sap.ui.xmlfragment("com.erpis.shiperp.createshipmentewm.fragment.RatePricingsDialog", this);
			...
			var oRatePricingTemplate = sap.ui.xmlfragment("com.erpis.shiperp.createshipmentewm.fragment.RatePricingColumnListItem", this);
			var oBindingInfo = {
			...
			this.getModel().create("/ShipmentQuerySet", oRequestData, {
				success: function (oData) {
					...
					if (!this.oRateAnalysisDialog) {
						this.oRateAnalysisDialog = sap.ui.xmlfragment("com.erpis.shiperp.createshipmentewm.fragment.RateAnalysisDialog", this);
			...
			this.getModel().create("/ShipmentQuerySet", oRequestData, {
				success: function (oData) {
					...
					if (!this.oConditionTablesDialog) {
						this.oConditionTablesDialog = sap.ui.xmlfragment("com.erpis.shiperp.createshipmentewm.fragment.ConditionTablesDialog", this);
		...
		onShowRateDetail: function () {
			...
			if (!this.oRateDetailDialog) {
				this.oRateDetailDialog = sap.ui.xmlfragment("com.erpis.shiperp.createshipmentewm.fragment.RateDetailsDialog", this);
				this.getView().addDependent(this.oRateDetailDialog);
			}
			var oObject = sap.ui.getCore().byId("tableRates").getSelectedItem().getBindingContext("local").getObject();
			var oRateDetailTemplate = sap.ui.xmlfragment("com.erpis.shiperp.createshipmentewm.fragment.RateDetailColumnListItem", this);
			var oBindingInfo = {
		...
		onPackBundle: function () {
			if (!this.oPackBundleDialog) {
				this.oPackBundleDialog = sap.ui.xmlfragment("com.erpis.shiperp.createshipmentewm.fragment.PackBundleDialog", this);
			...
			this.getModel().create("/ShipmentQuerySet", oRequestData, {
				success: function (oData) {
					...
					if (!this.oRepackOutboundHU) {
						this.oRepackOutboundHU = sap.ui.xmlfragment("com.erpis.shiperp.createshipmentewm.fragment.RePackItemDialog", this);
		...
		onSerialPress: function () {
			if (!this.oSerialDialog) {
				this.oSerialDialog = sap.ui.xmlfragment("com.erpis.shiperp.createshipmentewm.fragment.SerialDialog", this);
		...
		onReprint: function () {
			...
			var oReprintTemplate = sap.ui.xmlfragment("com.erpis.shiperp.createshipmentewm.fragment.ReprintColumnListItem", this);
			// var oFilter
		...
		onShowFDXGHoldLocationDetail: function () {
			...
			if (!this.oDialogFDXGHoldLocationDetail) {
				this.oDialogFDXGHoldLocationDetail = sap.ui.xmlfragment(
					"com.erpis.shiperp.createshipmentewm.fragment.carrier.FedExGroundHoldAtLocationDetailDialog",
					this);
		...
		onShowFDXEHoldLocationDetail: function () {
			...
			if (!this.oDialogFDXEHoldLocationDetail) {
				this.oDialogFDXEHoldLocationDetail = sap.ui.xmlfragment(
					"com.erpis.shiperp.createshipmentewm.fragment.carrier.FedExHoldAtLocationDetailDialog",
					this);
		...
		onShowFDXGCODRecipientDetail: function () {
			...
			if (!this.oDialogCODFDXGRecipientDetail) {
				this.oDialogCODFDXGRecipientDetail = sap.ui.xmlfragment(
					"com.erpis.shiperp.createshipmentewm.fragment.carrier.FedExGroundCODRecipientDetailDialog",
					this);
		...
		onShowFDXECODRecipientDetail: function () {
			...
			if (!this.oDialogCODFDXERecipientDetail) {
				this.oDialogCODFDXERecipientDetail = sap.ui.xmlfragment(
					"com.erpis.shiperp.createshipmentewm.fragment.carrier.FedExCODRecipientDetailDialog",
					this);
		...
		_getFreightCost: function (sWhichAction) {
			...
			this.getModel().create("/ShipmentQuerySet", oRequestData, {
				success: function (oData) {
					...
					if (!this.oRateDialog) {
						this.oRateDialog = sap.ui.xmlfragment("com.erpis.shiperp.createshipmentewm.fragment.RatesDialog", this);
