sap.ui.define([], function () {
	...
	return {
		...
		getTransparentLogoLink: function (sDummy) {
			var sRootPath = jQuery.sap.getModulePath("com.erpis.shiperp.sls.quickpacksls");
		...
		isVisibleImporter: function (isCreateShipment, isDomestic) {
			if (isCreateShipment && isDomestic) {
				return true;
			}
			return false;
