sap.ui.define([
	...
	return Controller.extend("com.erpis.shiperp.sls.salesordersls.controller.BaseController", {
		...
		_getMessagePopover: function () {
			if (!this._messagePopover) {
				// this._messagePopover = sap.ui.xmlfragment("com.erpis.shiperp.sls.salesordersls.fragment.MessagePopover", this);
		...
		getMasterCreatedOnData: function () {
			var oGlobalModel = this.getModel("global");
			var oCreatedOn = oGlobalModel.getProperty("/MasterCreatedOn");
			return oCreatedOn;

		},
		setMasterCreatedOnData: function (from, to) {
			var oGlobalModel = this.getModel("global");
			var oCreatedOn = {
				from: from,
				to: to
			};
			oGlobalModel.setProperty("/MasterCreatedOn", oCreatedOn);
