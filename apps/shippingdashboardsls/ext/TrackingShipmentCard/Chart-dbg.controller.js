(function () {
	"use strict";
	/*global sap, jQuery */
	jQuery.sap.declare("com.erpis.shiperp.sls.shippingdashboardsls.ext.TrackingShipmentCard.Chart");
	...
	*/
	...
	sap.ui.controller("com.erpis.shiperp.sls.shippingdashboardsls.ext.TrackingShipmentCard.Chart", {
		...
		onSelectData: function (oEvent) {
			if (!this._oPopover) {
				this._oPopover = sap.ui.xmlfragment("com.erpis.shiperp.sls.shippingdashboardsls.ext.TrackingShipmentCard.Popover", this);
				this.getView().addDependent(this._oPopover);
			}
			var sCarrier = oEvent.getParameters("data").data[0].data.Carrier;
			var oItemTemplate = sap.ui.xmlfragment("com.erpis.shiperp.sls.shippingdashboardsls.ext.TrackingShipmentCard.ColumnListItemTemplate", this);
