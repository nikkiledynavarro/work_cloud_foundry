sap.ui.define([
	"sap/ui/core/library",
	"com/erpis/shiperp/hr7/carrierperformancereportewm/controller/BaseController",
	"com/erpis/shiperp/hr7/carrierperformancereportewm/model/formatter",
	"sap/ui/model/json/JSONModel",
	"sap/m/MessageToast",
	"sap/ui/core/Fragment",
	"sap/ui/model/Filter",
	"sap/ui/model/FilterOperator",
	"com/erpis/shiperp/hr7/carrierperformancereportewm/common/DynamicFilter",
	"com/erpis/shiperp/hr7/carrierperformancereportewm/common/Utils",
	"sap/m/MessageBox"
	...
	return BaseController.extend("com.erpis.shiperp.hr7.carrierperformancereportewm.controller.Main", {
		...
		_readTheFilter: function (aFilter) {
			...
			this.getModel().read("/CarrierPerformanceSet", {
				filters: [aFilter],
				urlParameters: {
					select: "Status,FreightUnitKey,CarrierCode,EstimatedArrivalDate,PickupDate,ActualDeliveryDate,ActualDeliveryTime,GoodsIssueDate,Emails,Lgnum,TransactionType"
				},
		...
		generatePayload: function (aCarrierPerformanceReport, sEmailAddress) {
			var oPayload = {
				CarrierPerformance: aCarrierPerformanceReport,
