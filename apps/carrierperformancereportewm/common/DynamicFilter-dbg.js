			...
			for (var i = 0; i < aFilterItems.length; i++) {
				...
				if (oFilterData.FilterValue !== null && oFilterData.FilterValue !== "" && oGroupItem.getName() !==
					...
					if (sControlNameSpace === "sap.m.MultiComboBox") {
						...
						var oFrom = oInputFormat.parse(oFilterData.From);
						var oTo = oInputFormat.parse(oFilterData.To);
						aFilters.push(new Filter(oGroupItem.getName(), oFilterData.FilterOpType, new Date(oFrom), new Date(oTo)));
