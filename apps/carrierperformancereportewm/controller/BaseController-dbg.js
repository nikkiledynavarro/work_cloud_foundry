sap.ui.define([
	...
	return Controller.extend("com.erpis.shiperp.hr7.carrierperformancereportewm.controller.BaseController", {
		...
		_getMessagePopover: function () {
			if (!this._messagePopover) {
				this._messagePopover = sap.ui.xmlfragment("com.erpis.shiperp.hr7.carrierperformancereportewm.fragment.MessagePopover", this);
			}
