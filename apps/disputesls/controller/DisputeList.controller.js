sap.ui.define([
	...
	"com/erpis/shiperp/sls/disputesls/model/formatter",
	"sap/ui/model/Filter",
	...
	"com/erpis/shiperp/sls/disputesls/common/Utils"
	...
	return BaseController.extend("com.erpis.shiperp.sls.disputesls.controller.DisputeList", {

		//Link to "com.erpis.shiperp.sls.disputesls.model.formatter" for formatter functions
		formatter: formatter,
		oBundle: null,
		...
		_bindItemsOnTableByServiceUrlAndFilter: function (oTable, sPath, oSorter, aFilters) {
			...
			var oTemplate = sap.ui.xmlfragment("com.erpis.shiperp.sls.disputesls.fragment.DisputeListColumnListItem", this);
			this.showBusy();
