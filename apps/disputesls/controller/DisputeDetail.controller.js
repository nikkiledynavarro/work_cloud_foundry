...
sap.ui.define([
	...
	return BaseController.extend("com.erpis.shiperp.sls.disputesls.controller.DisputeDetail", {
		...
		onDisputeItemNotePressed: function (oEvent) {
			...
			oUploadCollections.bindItems({
				...
				template: sap.ui.xmlfragment("com.erpis.shiperp.sls.disputesls.fragment.UploadCollectionItemTemplate", this)
			});
